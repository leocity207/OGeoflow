...
namespace GeoJSON::IO
{
	...
	class Feature_Parser : public SAX_Parser<Feature_Parser>
	{
	public:
		...
		bool On_Feature_Collection(std::optional<::GeoJSON::Bbox>&& bbox, std::optional<std::string>&& id) {On_Root(std::move(bbox),std::move(id));};
